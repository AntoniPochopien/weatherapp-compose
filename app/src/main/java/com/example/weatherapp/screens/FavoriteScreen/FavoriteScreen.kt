package com.example.weatherapp.screens.FavoriteScreen
...
fun FavoriteScreen(navController: NavController, favoriteViewModel: FavoriteViewModel) {
    ...
    Scaffold(topBar = {
        CustomAppBar(title = "Favorites Cities", navController = navController) {
        ...
        LazyColumn(
            ...
            items(items = list) { cities ->
                CityRow(cities, navController, favoriteViewModel)
            }
        }
    }
}
